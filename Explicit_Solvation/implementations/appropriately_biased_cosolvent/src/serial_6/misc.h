...
void                  AlignNeighbors_debug       (std::vector <Polymer>* Polymers, std::vector <Particle*>* Cosolvent, std::vector <Particle*>* LATTICE, std::map <std::pair<std::string,std::string>, std::tuple <std::string, double, double, int, int>>* InteractionMap, std::array <double,8>* contacts, double* sysEnergy, double temperature, int x, int y, int z);

void                  IcedHeadRegrowth           (std::vector <Polymer>* Polymers, std::vector <Particle*>* Cosolvent, std::vector <Particle*>* LATTICE, std::map <std::pair<std::string,std::string>, std::tuple <std::string, double, double, int, int>>* InteractionMap, std::array <double,8>* contacts, bool* IMP_BOOL,    double* sysEnergy, double temperature, int p_index, int x, int y, int z);
void                  IcedMonomerSwingForward    (std::vector <Polymer>* Polymers, std::vector <Particle*>* Cosolvent, std::vector <Particle*>* LATTICE, std::map <std::pair<std::string,std::string>, std::tuple <std::string, double, double, int, int>>* InteractionMap, std::array <double,8>* contacts, double* prob_forw, double* energyf,   double temperature, int deg_poly, int p_index, int m_index, int x, int y, int z);
void                  IcedMonomerSwingBackward   (std::vector <Polymer>* Polymers, std::vector <Particle*>* Cosolvent, std::vector <Particle*>* LATTICE, std::map <std::pair<std::string,std::string>, std::tuple <std::string, double, double, int, int>>* InteractionMap, std::array <double,8>* contacts, double* prob_back, double* energyb,   double temperature, int deg_poly, int p_index, int m_index, int x, int y, int z);
void                  IcedNeighborAlignment      (std::vector <Polymer>* Polymers, std::vector <Particle*>* Cosolvent, std::vector <Particle*>* LATTICE, OrientationFlip* FlipStates, std::map <std::pair<std::string,std::string>, std::tuple <std::string, double, double, int, int>>* InteractionMap, std::array <double,8>* contacts, double* Eforw, double temperature, int m_index, int x, int y, int z); 
