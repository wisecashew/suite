...
if __name__=="__main__":
    ...
    for U in U_list:
        ...
        for temp in temperatures: 
            ...
            for num in num_list: 
                ...
                f = df["ms1_aligned"].values[-2500:] 
                # print (2*df["mm_tot"].values[-3000:]+df["ms1_tot"].values[-3000:]) 
    ...
    for U in U_list:
        ...
        if args.cs == 0: 
            ...
            rgba_color = cm.PiYG(divnorm (chi_1))
        plt.errorbar ( temperatures, PLOT_DICT[U][0]/np.array(temperatures) , yerr=PLOT_DICT[U][1]/np.array(temperatures), linewidth=1, fmt='none', capsize=2, color='k', label="_nolabel_")
