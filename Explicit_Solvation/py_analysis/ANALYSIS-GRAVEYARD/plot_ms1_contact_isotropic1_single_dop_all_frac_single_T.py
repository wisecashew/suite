...
if __name__=="__main__":
    ...
    for T in temperatures:
        ...
        for U in U_list: 
            ...
            for num in num_list: 
                ...
                ms_list = np.hstack ( (ms_list, np.mean(df["ms2_tot"].values[-2000:]/( df["ms1_tot"].values[-2000:]+df["ms2_tot"].values[-2000:] ) ) ) )
    ...
    for T in temperatures:
        ...
        plt.plot     ( frac_list, PLOT_DICT[T], linestyle='-',  markeredgecolor='k', linewidth=3, color=cm.coolwarm(divnorm(T)), label="_nolabel_", markersize=10, marker='o')
        i += 1
