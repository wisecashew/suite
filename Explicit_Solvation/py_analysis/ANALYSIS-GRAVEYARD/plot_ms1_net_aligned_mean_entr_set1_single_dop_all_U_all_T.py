...
if __name__=="__main__":
    ...
    for U in U_list:
        ...
        for temp in temperatures: 
            ...
            for num in num_list: 
                ...
                ms_list = np.hstack ( (ms_list, np.mean(f) ) ) # np.mean( f**2 )-(np.mean(f) )**2  ) )
    ...
    for U in U_list:
        ...
        if args.cs == 0: 
            ...
            rgba_color = cm.PiYG(divnorm (chi_1))
        plt.errorbar ( temperatures, PLOT_DICT[U][0], yerr=PLOT_DICT[U][1]/ms_max, linewidth=1, fmt='none', capsize=2, color='k', label="_nolabel_")
