...
if __name__ == "__main__":
	...
	for U in U_list:
		...
		nu = df.loc[df["U"] == U]
		ax.errorbar(nu["T"], nu["delta_mean"]/2, yerr=nu["delta_err"]/2, linewidth=1/1.3, capsize=2, color=rgba_color, \
		ecolor='k', fmt='none', label='_nolegend_')
		ax.plot(nu["T"], nu["delta_mean"]/2, linewidth=3/1.3, marker='o',markersize=8/1.3, markeredgecolor='k', \
	...
	ax.yaxis.set_major_formatter(tck.StrMethodFormatter('{x:1.2f}') )
	ax.set_aspect('auto')
