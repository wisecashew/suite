...
if __name__ == "__main__":
	...
	for U in U_list:
		...
		for T in temperatures:
			df_T = nu [nu["T"]==T]
			df_T = df_T [ df_T["d"]<17]
			nu_averaged.append ( np.mean(df_T["nu_mean"]/2) )
		INTEGRATED_DB["T"].extend (temperatures)
		INTEGRATED_DB["NU_MEAN"].extend (nu_averaged)
		INTEGRATED_DB["U"].extend ([U]*len(temperatures))
