...
parser.add_argument('-T', metavar='T', dest='T', type=float, action='store', nargs='+', help='enter temperatures.')
...
divnorm = matplotlib.colors.SymLogNorm ( 0.001, vmin=-1000, vmax=0 ) # this is for entropy 
...
if __name__ == "__main__":    
    ...
    print ("rg_max = ", rg_max)
    i=0
    chi_list = [0, -0.1, -1, -5, -10, -50, -100, -500, -1000]
    for U in U_list:
        chi_1 = chi_list[i]
        # print(chi_1)
