...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
double CalculateEnergy               (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array<double,3>* E, std::array<double,3>* contacts, int x, int y, int z);
...
double NeighborEnergy                (std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, int ss_index, int x, int y, int z); 
...
void dumpEnergy              (double sysEnergy, int step, std::array <double,3>* contacts, std::string filename);
...
void                  TailRotation_UNBIASED_debug        (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
void                  HeadRotation_UNBIASED_debug        (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
void                  EndRotation_UNBIASED_debug         (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);

//~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#

void                  TailRotation_UNBIASED        (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
void                  HeadRotation_UNBIASED        (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
void                  EndRotation_UNBIASED         (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
...
void                  forward_reptation_with_tail_biting_new        (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, double* frontflow_energy, int deg_poly, int index, int x, int y, int z);
...
void                  backward_reptation_with_head_butting_new      (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, double* frontflow_energy, int deg_poly, int index, int x, int y, int z);
...
void                  forward_reptation_without_tail_biting_new     (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, std::array <int,3>* to_slither, double* frontflow_energy, int deg_poly, int index, int x, int y, int z);
...
void                  backward_reptation_without_head_butting_new   (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, std::array <int,3>* to_slither, double* frontflow_energy, int deg_poly, int index, int x, int y, int z);

// necessary perform reptation 
void                  ForwardReptation_UNBIASED_debug           (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
void                  BackwardReptation_UNBIASED_debug          (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
void                  Reptation_UNBIASED_debug                  (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);

//~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#
//~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#

void                  ForwardReptation_UNBIASED                 (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
void                  BackwardReptation_UNBIASED                (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
void                  Reptation_UNBIASED                        (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
...
void                  TailRegrowth_BIASED_debug                 (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* prob_o_to_n, double* frontflow_energy, double temperature, int deg_poly, int p_index, int m_index, int x, int y, int z); 
void                  HeadRegrowth_BIASED_debug                 (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* prob_o_to_n, double* frontflow_energy, double temperature, int deg_poly, int p_index, int m_index, int x, int y, int z); 
void                  BackFlowFromTailRegrowth_BIASED_debug     (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::vector <std::array <int,3>>* old_cut, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* prob_n_to_o, double* backflow_energy, double temperature, int deg_poly, int p_index, int m_index, int recursion_depth, int x, int y, int z); 
void                  BackFlowFromHeadRegrowth_BIASED_debug     (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::vector <std::array <int,3>>* old_cut, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* prob_n_to_o, double* backflow_energy, double temperature, int deg_poly, int p_index, int m_index, int recursion_depth, int x, int y, int z); 
void                  ChainRegrowth_BIASED_debug                (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z); 

//~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#

void                  TailRegrowth_BIASED                       (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* prob_o_to_n, double* frontflow_energy, double temperature, int deg_poly, int p_index, int m_index, int x, int y, int z); 
void                  HeadRegrowth_BIASED                       (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* prob_o_to_n, double* frontflow_energy, double temperature, int deg_poly, int p_index, int m_index, int x, int y, int z); 
...
void                  ChainRegrowth_BIASED                      (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z); 
...
void                  PolymerFlip_BIASED                        (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
void                  PolymerFlip_BIASED_debug                  (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
...
void                  PerturbSystem_BIASED         (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, std::array <int,4>* attempts, bool* IMP_BOOL, bool v, double* sysEnergy, double temperature, int* move_number, int x, int y, int z);
void                  PerturbSystem_BIASED_debug   (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,3>* E, std::array <double,3>* contacts, std::array <int,4>* attempts, bool* IMP_BOOL, bool v, double* sysEnergy, double temperature, int* move_number, int x, int y, int z);
