...
void                  TailRotation_UNBIASED_debug        (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,NEDIM>* E, std::array <double,NCDIM>* contacts, std::array<double,3>* magnetization, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
void                  HeadRotation_UNBIASED_debug        (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,NEDIM>* E, std::array <double,NCDIM>* contacts, std::array<double,3>* magnetization, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
void                  EndRotation_UNBIASED_debug         (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,NEDIM>* E, std::array <double,NCDIM>* contacts, std::array<double,3>* magnetization, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
...
void                  ForwardReptation_UNBIASED_debug           (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,NEDIM>* E, std::array <double,NCDIM>* contacts, std::array<double,3>* magnetization, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
void                  BackwardReptation_UNBIASED_debug          (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,NEDIM>* E, std::array <double,NCDIM>* contacts, std::array<double,3>* magnetization, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
void                  Reptation_UNBIASED_debug                  (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,NEDIM>* E, std::array <double,NCDIM>* contacts, std::array<double,3>* magnetization, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z);
...
void                  BackFlowFromTailRegrowth_BIASED_debug     (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::vector <std::array <int,3>>* old_cut, std::array <double,NEDIM>* E, std::array <double,NCDIM>* contacts, std::array<double,3>* magnetization, bool* IMP_BOOL, double* prob_n_to_o, double* backflow_energy, double temperature, int deg_poly, int p_index, int m_index, int recursion_depth, int x, int y, int z); 
void                  BackFlowFromHeadRegrowth_BIASED_debug     (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::vector <std::array <int,3>>* old_cut, std::array <double,NEDIM>* E, std::array <double,NCDIM>* contacts, std::array<double,3>* magnetization, bool* IMP_BOOL, double* prob_n_to_o, double* backflow_energy, double temperature, int deg_poly, int p_index, int m_index, int recursion_depth, int x, int y, int z); 
void                  ChainRegrowth_BIASED_debug                (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,NEDIM>* E, std::array <double,NCDIM>* contacts, std::array<double,3>* magnetization, bool* IMP_BOOL, double* sysEnergy, double temperature, int index, int x, int y, int z); 
...
void                  PerturbSystem_UNBIASED       (std::vector <Polymer>* Polymers, std::vector <Particle*>* Cosolvent, std::vector <Particle*>* LATTICE, std::array <double,8>* E, std::array <double,8>* contacts, std::array <int,NADIM>* attempts, bool* IMP_BOOL, bool v, double* sysEnergy, double temperature, int* move_number, int x, int y, int z);
void                  PerturbSystem_BIASED         (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,NEDIM>* E, std::array <double,NCDIM>* contacts, std::array <double,3>* magnetization, std::array <int,NADIM>* attempts, bool* IMP_BOOL, bool v, double* sysEnergy, double temperature, int* move_number, int x, int y, int z);
void                  PerturbSystem_BIASED_debug   (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array <double,NEDIM>* E, std::array <double,NCDIM>* contacts, std::array <double,3>* magnetization, std::array <int,NADIM>* attempts, bool* IMP_BOOL, bool v, double* sysEnergy, double temperature, int* move_number, int x, int y, int z);
