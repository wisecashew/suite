...
void InputParser (int dfreq, int max_iter, bool r, std::string positions, \
    ...
    std::string stats_file, std::string lattice_file_read, std::string WL_file); 
...
//~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#
// extraction methods 
std::vector <Polymer>    ExtractPolymersFromFile    (std::string polymer_file, int x, int y, int z);
std::vector <Polymer>    ExtractPolymersFromFile    (std::string polymer_file);
std::vector <Polymer>    ExtractPolymersFromTraj    (std::string trajectory, std::string position, int step_number, int x, int y, int z);
int                      ExtractIndexOfFinalMove    (std::string trajectory_file);
double                   ExtractEnergyOfFinalMove   (std::string energy_file); 
int                      ExtractNumberOfPolymers    (std::string polymer_file);
std::array <double, 8>   ExtractTopologyFromFile    (std::string topology_file);
std::array <double,5>    ExtractWLParamsFromFile    (std::string WL_file);
std::vector <Particle*>  ExtractLatticeFromRestart  (std::string restart_file, int* step_num, int x, int y, int z);
