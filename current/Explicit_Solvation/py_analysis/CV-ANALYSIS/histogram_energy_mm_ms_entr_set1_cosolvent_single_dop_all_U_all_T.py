...
if __name__=="__main__":
    ...
    for U in U_list:
        ...
        for temp in temperatures: 
            ...
            for num in num_list: 
                ...
                contacts_list = np.hstack ( (contacts_list, df["ms1_tot"].values[-2000:]) )
    ...
    for U in U_list:
        ...
        plt.hist (mm_mean[0], bins=contacts[0], density=True)
        plt.hist (ms_mean[0], bins=contacts[0], density=True)
        i += 1
