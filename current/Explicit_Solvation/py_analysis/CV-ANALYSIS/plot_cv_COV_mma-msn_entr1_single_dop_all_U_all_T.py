...
if __name__=="__main__":
    ...
    for U in U_list:
        ...
        for temp in temperatures: 
            ...
            for num in num_list: 
                ...
                f = df["mm_aligned"].values[-1500:]*Emm_a
                g = df["ms1_naligned"].values[-1500:]*Ems1_n
    ...
    # print ("ms_max = ",ms_max)
    # ms_max = 1
    f = open ("CV-COV-MMA-MSN-output.mc", 'w')
    i=0
    ymin = 1
    for U in U_list:
        ...
        for i in range(len(PLOT_DICT[U][0])):
            f.write ("{:>2.2e} ".format(PLOT_DICT[U][0][i]/temperatures[i]**2))
        f.write ("\n")
        # for c in PLOT_DICT[U][0]:
        #     f.write ("{:>2.2e} ".format(c))  
        # f.write ("\n")
