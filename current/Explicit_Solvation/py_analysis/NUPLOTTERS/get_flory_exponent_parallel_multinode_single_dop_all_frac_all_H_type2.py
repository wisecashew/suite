...
if __name__ == "__main__":
    ...
    i = 0
    enthalpies = args.H # aux.get_enthalpies ( os.listdir (U_list[0]+"/DOP_32/.") )# args.H
    print (enthalpies)
    # instantiating pool
    ...
    for H in enthalpies:
        ...
        # plt.savefig ("plot_H_"+str(U)+"_"+str(args.d1)+"_"+str(args.d2)+"set_"+str(args.set)+"_type2.png", dpi=1200, bbox_inches='tight')
