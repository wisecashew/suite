...
if args.cs == 3:
    ...
    # divnorm = matplotlib.colors.SymLogNorm ( 0.0001, vmin=-0.2, vmax=0.1 )
...
if __name__ == "__main__":
    ...
    for U in U_list:
        ...
        if U == "U10": 
            PLOT_DICT[U][0][:] = PLOT_DICT[U][0][1]
        elif U == "U9":
            PLOT_DICT[U][0][:-2] = PLOT_DICT[U][0][1]
        f.write("Rg^2: ") 
        for elem in rg_mean: 
    ...
    # ax.set_yticks (np.linspace (0.55, 2.7, 11) )
