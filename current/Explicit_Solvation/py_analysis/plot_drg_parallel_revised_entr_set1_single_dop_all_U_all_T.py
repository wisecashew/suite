...
if __name__ == "__main__":    
    ...
    for U in U_list:
        ...
        # ax.errorbar ( temperatures, np.gradient(PLOT_DICT[U][0]/rg_max, temperatures), yerr= PLOT_DICT[U][1]/rg_max, linewidth=1, capsize=2, color=rgba_color, ecolor='k', fmt='none', label='_nolegend_')
        ax.plot     ( temperatures, np.gradient(PLOT_DICT[U][0]/rg_max, temperatures), marker='o', markeredgecolor='k', \
