...
if __name__=="__main__":
    ...
    for U in U_list:
        ...
        ax.errorbar ( temperatures, np.asarray (mm_mean)/mm_max, yerr=mm_err/mm_max, linewidth=1, fmt='none', capsize=2, color='k', label='_nolegend_')
        ax.plot (temperatures, np.asarray(mm_mean)/mm_max, marker='o', markeredgecolor='k', linestyle='-', linewidth=2, c=rgba_color, label='_nolegend_', markersize=10)
        i += 1
