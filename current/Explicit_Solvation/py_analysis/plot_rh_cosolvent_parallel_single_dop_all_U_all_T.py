...
parser.add_argument('--png-name', type=str, dest='pn', action='store', help='enter a name for the png.')
...
if __name__ == "__main__":    
    ...
    f = open("INV_RH_DATA_"+str(dop)+".mc", "w") 
    ...
    # plot Uexcl...
    if excl_vol_bool:
        f = open ("INV_RH_DATA_"+str(dop)+".mc", 'a') 
        f.write ("U = Uexcl:\n")
...
######################################
    ...
    plt.savefig   ( args.pn+".png", dpi=800)
    if show_plot_bool:
        plt.show() 
