...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
double CalculateEnergy      (std::vector <Polymer>* Polymers, std::vector <Particle>* Solvent, int x, int y, int z, double Emm_a, double Emm_n, double Ems_a, double Ems_n, double Ems_h, double Eb_f, double Eb_u, double* m_neighbor, int* a_contacts, int* n_contacts, int* h_contacts);
...
void dumpEnergy              (double sysEnergy, int step, double m_contacts, int a_contacts, int n_contacts, int h_contacts, std::string filename); 
...
std::vector <Polymer> TailRotation_Rosenbluth      (std::vector <Polymer>* Polymers, std::vector <Particle>* Solvent, int index, int x, int y, int z, bool* IMP_BOOL, double* rweight);
std::vector <Polymer> HeadRotation_Rosenbluth      (std::vector <Polymer>* Polymers, std::vector <Particle>* Solvent, int index, int x, int y, int z, bool* IMP_BOOL, double* rweight);
std::vector <Polymer> EndRotation_Rosenbluth       (std::vector <Polymer>* Polymers, std::vector <Particle>* Solvent, int index, int x, int y, int z, bool* IMP_BOOL, double* rweight);
std::vector <Polymer> KinkJump_Rosenbluth          (std::vector <Polymer>* Polymers, std::vector <Particle>* Solvent, int index, int x, int y, int z, bool* IMP_BOOL, double* rweight);
std::vector <Polymer> CrankShaft_Rosenbluth        (std::vector <Polymer>* Polymers, std::vector <Particle>* Solvent, int index, int x, int y, int z, bool* IMP_BOOL, double* rweight);
std::vector <Polymer> ForwardReptation_Rosenbluth  (std::vector <Polymer>* Polymers, std::vector <Particle>* Solvent, int index, int x, int y, int z, bool* IMP_BOOL, double* rweight);
std::vector <Polymer> BackwardReptation_Rosenbluth (std::vector <Polymer>* Polymers, std::vector <Particle>* Solvent, int index, int x, int y, int z, bool* IMP_BOOL, double* rweight);
std::vector <Polymer> Reptation_Rosenbluth         (std::vector <Polymer>* Polymers, std::vector <Particle>* Solvent, int index, int x, int y, int z, bool* IMP_BOOL, double* rweight);
