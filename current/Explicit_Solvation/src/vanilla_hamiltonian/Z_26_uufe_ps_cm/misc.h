...
void InputParser (int dfreq, int max_iter, bool r, std::string positions, std::string topology, std::string dfile, std::string efile, std::string mfile, std::string stats_file, std::string lattice_file_read); 
...
Polymer                          makePolymer         (std::vector <std::array <int,3>> locations, std::vector<std::string> pmer_types);
Polymer                          makePolymer         (std::vector <std::array <int,3>> locations, std::vector<int> pmer_spins, std::vector<std::string> particle_types);
// create a lattice 
...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
double CalculateEnergy      (std::vector <Polymer>* Polymers, std::vector<Particle*>* LATTICE, int x, int y, int z, std::array<double,5>* E, std::array<double,5>* contacts);
...
void                  PerturbSystem                (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, int x, int y, int z, bool v, bool* IMP_BOOL, double* rweight, std::array <int,3>* attempts, int* move_number, std::pair <std::vector<std::array<int,3>>, std::vector<std::array<int,3>>>* memory3, int* monomer_index, int* back_or_front);
void                  ReversePerturbation          (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, int y, int z, bool v, int move_number, std::pair <std::vector<std::array<int,3>>, std::vector<std::array<int,3>>>* memory3, int monomer_index, int back_or_front);
//~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#
