...
void                             AddSolvent          (int x, int y, int z, std::map <std::array<int,3>, Particle*>* LATTICE);
...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
double CalculateEnergy      (std::vector <Polymer>* Polymers, std::map<std::array<int,3>,Particle*>* LATTICE, int x, int y, int z, double Emm_a, double Emm_n, double Ems_a, double Ems_n, double* mm_aligned, double* mm_naligned, int* ms_aligned, int* ms_naligned);
...
void dumpOrientation         (std::vector <Polymer> * Polymers, std::map<std::array<int,3>,Particle*>* LATTICE, int step, std::string filename, int x, int y, int z);
...
void                  KinkJump                     (std::vector <Polymer>* Polymers, std::map <std::array <int,3>, Particle*>* LATTICE, int index, int x, int y, int z, bool* IMP_BOOL, double* rweight, std::pair <std::vector<std::array<int,3>>, std::vector<std::array<int,3>>>* memory);
void                  CrankShaft                   (std::vector <Polymer>* Polymers, std::map <std::array <int,3>, Particle*>* LATTICE, int index, int x, int y, int z, bool* IMP_BOOL, double* rweight, std::pair <std::vector<std::array<int,3>>, std::vector<std::array<int,3>>>* memory);
void                  ForwardReptation 			   (std::vector <Polymer>* Polymers, std::map <std::array <int,3>, Particle*>* LATTICE, int index, int x, int y, int z, bool* IMP_BOOL, double* rweight, std::pair <std::vector<std::array<int,3>>, std::vector<std::array<int,3>>>* memory);
void                  BackwardReptation 		   (std::vector <Polymer>* Polymers, std::map <std::array <int,3>, Particle*>* LATTICE, int index, int x, int y, int z, bool* IMP_BOOL, double* rweight, std::pair <std::vector<std::array<int,3>>, std::vector<std::array<int,3>>>* memory);
void                  Reptation  			       (std::vector <Polymer>* Polymers, std::map <std::array <int,3>, Particle*>* LATTICE, int index, int x, int y, int z, bool* IMP_BOOL, double* rweight, std::pair <std::vector<std::array<int,3>>, std::vector<std::array<int,3>>>* memory);
