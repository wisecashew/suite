...
void UncoordinatedSolvationShellFlip_UNBIASED ( std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, std::array<double,4>* E, std::array<double,4>* contacts, \
	bool* IMP_BOOL, double* sysEnergy, double temperature, int x, int y, int z ){
	...
	for (int i{0}; i<nflips; ++i){
		...
		for ( std::array <int,3>& ne: ne_list ){
			...
			initial_orientation_map.insert({lattice_index(ne, y, z), (*LATTICE)[ lattice_index(ne, y, z) ]->orientation}); 
			(*LATTICE)[ lattice_index(ne, y, z) ]->orientation = rng_uniform(0, 25); // (*LATTICE)[ solvent_indices[i] ]->orientation; 
...
// ~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~
//             Start of SolvationShellFlip_BIASED
// ~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~

void SolvationShellFlip_BIASED (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, \
	std::array<double,4>* E, std::array<double,4>* contacts, \
	bool* IMP_BOOL, double* sysEnergy, double temperature, int x, int y, int z ){
    ...
    std::array <double,4> c_contacts2 = {0,0,0,0};
...
// ~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~
//             End of SolvationShellFlip_BIASED
// ~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~
...
void TailRegrowthPlusOrientationFlip_BIASED (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, \
	...
	std::array <std::array<double,4>,25> contacts_store; 
...
void BackFlowFromTailRegrowthPlusOrientationFlip_BIASED (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, \
	std::vector<std::array<int,3>>* old_cut, std::vector <int>* old_ori, std::array <double,4>* E, std::array <double,4>* contacts, bool* IMP_BOOL, double* prob_n_to_o, \
	double* backflow_energy, double temperature, int deg_poly, int p_index, int m_index, int recursion_depth, int x, int y, int z){
...
void PerturbSystem_BIASED (std::vector <Polymer>* Polymers, std::vector <Particle*>* LATTICE, \
	...
	switch (r) {
		...
		case (5):
			...
			SolvationShellFlip_BIASED (Polymers, LATTICE, E, contacts, IMP_BOOL, sysEnergy, temperature, x, y, z); 
			*move_number    = r;
			(*attempts)[r] += 1;
			break;
		...
		default: 
			if (v) {
				std::cout << "Performing a uncoordinating orientation flip..." << std::endl;
			}
			UncoordinatedSolvationShellFlip_UNBIASED ( Polymers, LATTICE, E, contacts, IMP_BOOL, sysEnergy, temperature, x, y, z );
			*move_number    = 8;
			(*attempts)[8] += 1; 
			break; 
		*/
