...
if __name__=="__main__":
    ...
    for U in U_list:
        ...
        for temp in temperatures: 
            ...
            for num in num_list:
                df = pd.read_csv(str(U)+"/DOP_"+str(args.dop)+"/"+str(temp)+"/"+args.e+"_"+str(num), sep=' \| ', names=["energy", "mm_tot", "m1m1", "m2m2", "m1m2", "ms_tot", "m1s1", "m2s1", "time_step"], engine='python', skiprows=args.s)
    ...
    if args.ev:
        df = pd.read_csv ( "Uexcl/DOP_"+str(args.dop)+"/0.1/"+args.e, sep= ' \| ', names=["energy", "mm_tot", "m1m1", "m2m2", "m1m2", "ms_tot", "m1s1", "m2s1", "time_step"], engine='python' )
