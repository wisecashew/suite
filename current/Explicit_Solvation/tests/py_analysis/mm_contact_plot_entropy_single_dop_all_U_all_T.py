...
if __name__=="__main__":
    ...
    for U in U_list:
        ...
        ax.errorbar(temperatures, np.asarray(mm_mean)/mm_max, yerr=np.asarray(mm_err)/mm_max, fmt='o', markeredgecolor='k', linestyle='-', elinewidth=1, capsize=0, color=cm.copper(i/9), label='_nolegend_')   
        i += 1
