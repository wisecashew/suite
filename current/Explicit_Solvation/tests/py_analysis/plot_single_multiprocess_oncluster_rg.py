...
import argparse 
parser = argparse.ArgumentParser(description="Read a trajectory file and obtain a radius of gyration plot given a degree of polymerization for a single potential energy surface and temperature.")
...
parser.add_argument('-T', dest='T', metavar='T', action='store', type=float, help='Temperature to plot.')
parser.add_argument('-U', dest='U', metavar='UX', action='store', type=str, help='Potential energy to plot.') 
...
if __name__ == "__main__":    
    ...
    aux.plot_rg_parallelized_single ( args.U, args.T, args.dop, args.s, args.ev, args.c, args.sp )
