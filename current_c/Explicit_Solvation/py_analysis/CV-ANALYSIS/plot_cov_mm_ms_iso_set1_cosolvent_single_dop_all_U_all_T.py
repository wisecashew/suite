...
if __name__=="__main__":
    ...
    for T in temperatures:
        plt.errorbar ( frac_list, PLOT_DICT[T][0] , yerr=PLOT_DICT[T][1], linewidth=1, fmt='none', capsize=2, color='k', label="_nolabel_")
        plt.plot     ( frac_list, PLOT_DICT[T][0] , linestyle='-', marker='o',  markeredgecolor='k', linewidth=3, color=colors[i], label="_nolabel_", markersize=10)
        i += 1
