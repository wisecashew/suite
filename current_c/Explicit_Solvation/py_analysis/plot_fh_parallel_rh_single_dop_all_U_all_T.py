...
import argparse 
parser = argparse.ArgumentParser(description="Read a trajectory file and obtain the hydrodynamic radius plot given a degree of polymerization over a range of temperatures and potential energy surfaces.")
...
if __name__ == "__main__":    
    ...
    aux.plot_rh_parallelized ( args.dop, args.s, args.ev, args.c, args.sp )
