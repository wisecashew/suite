...
for U in U_list:
    ...
    for temp in temperatures: 
        if U != "Uexcl": 
            for idx in ["1", "2", "3", "4", "5"]:
                ...
                mm_list = np.hstack ( (mm_list, df["mm"].values[args.s:] - (args.dop-1) ) )
    ...
    if U == "Uexcl":
        ...
        plt.errorbar(temperatures, mm_mean, yerr=mm_err, linestyle='-', elinewidth=1, linewidth=1.5, capsize=2, color=cm.copper(i/9))   
    i = i+1
