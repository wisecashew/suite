...
if __name__=="__main__":
    ...
    for T in temperatures:
        ...
        for U in U_list: 
            ...
            for num in num_list: 
                ...
                ms1_list = np.hstack ( (ms1_list, df["ms1_tot"].values[-2000:]/args.dop ) )
                ms2_list = np.hstack ( (ms2_list, df["ms2_tot"].values[-2000:]/args.dop ) )
                mm_list  = np.hstack ( (mm_list , df["mm_tot" ].values[-2000:]*2/args.dop)) 
        ...
        PLOT_DICT [T] = (ms1_mean/26, ms2_mean/26, mm_mean/26)
    ...
    for T in temperatures:
        ...
        fig, ax = plt.subplots(num=i+1, figsize=(3,3))
