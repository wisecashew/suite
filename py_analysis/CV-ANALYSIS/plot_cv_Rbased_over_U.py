...
if __name__=="__main__":
	...
	for U in U_list:
		...
		ax.plot     ( temperatures, PLOT_DICT[U][0], linestyle='--', marker='o',  markeredgecolor='k', linewidth=1, color=rgba_color, label="_nolabel_", markersize=args.ms, clip_on=args.clipon, zorder=10)
