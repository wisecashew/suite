...
if __name__=="__main__":
    ...
    f = open ("CV-MS-output.mc", 'w')
    for U in U_list:
        rgba_color = cm.PiYG (divnorm (chi_list[i]) )
        plt.errorbar ( temperatures, PLOT_DICT[U][0][-7:]/args.dop, yerr=PLOT_DICT[U][1][-7:]/args.dop, linewidth=1, fmt='none', capsize=2, color='k', label="_nolabel_")
