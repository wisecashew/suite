...
if __name__=="__main__":
    ...
    for U in U_list: 
        ...
        ax.errorbar ( temperatures, PLOT_DICT[U][0]/max_op, yerr=PLOT_DICT[U][1]/max_op, fmt='none', linestyle='-', elinewidth=1, capsize=2, linewidth=1, color=rgba_color, label='_nolegend_')
