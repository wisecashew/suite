...
if __name__=="__main__":
    ...
    param_list  = [-0.52, -0, -0.4, -0.4, -0.65, -0.65, 0.25, 0.25, 0.01, 0.01]
    N           = 100
    ...
    # go from -4 to wherever loops start
    ranges = [np.arange(-4, 0.1, 0.1), [-3.7, -2.075, -2.07, -1]  ]
    ...
    ax.set_yticks ([0.001, 0.01, 0.1, 1.0, 10.0, 50])
