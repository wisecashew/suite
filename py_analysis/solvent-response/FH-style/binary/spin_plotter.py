...
parser.add_argument ("-pwms", dest="pwms", type=float, nargs='+', action='store', help="Provide PW_MS.")
parser.add_argument ("-pwmm", dest="pwmm", type=float, nargs='+', action='store', help="Provide PW_MM.")
parser.add_argument ("-pwss", dest="pwss", type=float, nargs='+', action='store', help="Provide PW_SS.")
