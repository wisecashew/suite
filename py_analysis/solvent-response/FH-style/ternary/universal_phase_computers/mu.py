...
class sym_mu_ps:
	...
	phi_s1, phi_p1, phi_s1, phi_p2 = sym.symbols('phi_s1 phi_p1 phi_s2 phi_p2')
	...
	delta_mu_s = lambda self, phi_s1, phi_p1, phi_s2, phi_p2: L_dmu_s(phi_s1, phi_p1, phi_s2, phi_p2)
	...
	def find_solution_in_nbrhd_pert_in_p2(self, crit_point, loglims=[-3,-10,100], eps=0.01):
		...
		for pert in pert_scale:
			def mu_init(phi_):
				eq1 = L_dmu_s(phi_[0], phi_[1], phi_[2], crit_point[1] + pert * tangent_vector[1])
				eq2 = L_dmu_p(phi_[0], phi_[1], phi_[2], crit_point[1] + pert * tangent_vector[1])
				eq3 = L_dmu_c(phi_[0], phi_[1], phi_[2], crit_point[1] + pert * tangent_vector[1])
				return [eq1, eq2, eq3]
